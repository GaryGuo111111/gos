...
public class Goods implements Serializable {
    ...
    private Boolean isOnlyRelevance;
    ...
    public Boolean getHasRelevance() {
        return hasRelevance;
    }

    public void setHasRelevance(Boolean hasRelevance) {
        this.hasRelevance = hasRelevance;
    }

    public Boolean getIsOnlyRelevance() {
        return isOnlyRelevance;
    }

    public void setIsOnlyRelevance(Boolean isOnlyRelevance) {
    ...
    public Boolean getIsMaxBuy() {
        return isMaxBuy;
    }

    public void setIsMaxBuy(Boolean isMaxBuy) {
